...
Handles user registration, authentication, sessions, and offline messages
"""
...
class UserManager:
    """
    Manages all user operations including authentication, sessions, and offline messages
    """
